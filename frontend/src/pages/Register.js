...
const styles = {
  ...
  logo: { fontSize: '24px', fontWeight: '700', color: '#0A1628', marginBottom: '8px' },
  ...
  input: {
    ...
    borderRadius: '8px', fontSize: '14px', color: '#1E293B', outline: 'none', marginBottom: '16px',
  },
  btn: {
  ...
  error: { background: '#FEF2F2', color: '#DC2626', padding: '12px 16px', borderRadius: '8px', fontSize: '14px', marginBottom: '16px' },
...
export default function Register() {
  ...
  const [form, setForm] = useState({ email: '', full_name: '', password: '', company: '' });
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.subtitle}>Create your client account</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input style={styles.input} type="email" placeholder="jane@company.com"
            value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} required />
          <label style={styles.label}>Company</label>
          <input style={styles.input} type="text" placeholder="Your company"
